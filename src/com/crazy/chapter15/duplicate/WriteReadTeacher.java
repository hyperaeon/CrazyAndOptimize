...
public class WriteReadTeacher {
	...
	public static void main(String[] args) {
		try (ObjectOutputStream oos = new ObjectOutputStream(
				new FileOutputStream(Constants.basicPath + "teacher.txt"));
				ObjectInputStream ois = new ObjectInputStream(
						new FileInputStream(Constants.basicPath + "teacher.txt"));) {
			...
			System.out.println(t.getName() + " " + t.getStudent().getName()
					+ " " + t.getStudent().getAge());
		} catch (IOException e) {
			e.printStackTrace();
