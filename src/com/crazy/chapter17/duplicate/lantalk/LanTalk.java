...
public class LanTalk extends JFrame {
	...
	private DefaultListModel<UserInfo> listModel = new DefaultListModel<UserInfo>();

	private JList<UserInfo> friendsList = new JList<UserInfo>();
	...
	public void processMsg(DatagramPacket singlePacket, boolean single) {
		...
		if (srcUser != null) {
			...
			alertUser.getChatFrame().addString(
					srcUser.getName() + tipMsg + "..................." + formatter.format(new Date()) + ")\n"
	...
	class ImageCellRenderer extends JPanel implements ListCellRenderer<UserInfo> {
		 ...
		 */
		@Override
		public Component getListCellRendererComponent(JList<? extends UserInfo> list, UserInfo value, int index,
