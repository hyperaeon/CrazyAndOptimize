...
public class HttpClientUtil {
	...
	private static List<Header> headerList = new ArrayList<Header>();
	
	/**
	 * 初始化公共的Header信息
	 */
	static {
		headerList.add(new Header("Accept", "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8"));
		headerList.add(new Header("Accept-Encoding", "gzip, deflate"));
		headerList.add(new Header("Accept-Language", "zh-CN,zh;q=0.8"));
		headerList.add(new Header("Cache-Control", "max-age=0"));
		headerList.add(new Header("Connection", "keep-alive"));
		headerList.add(new Header("Host", ConstantUtil.HOST));
		headerList.add(new Header("Origin", ConstantUtil.ORIGIN));
		headerList.add(new Header("Upgrade-Insecure-Requests", "1"));
		headerList.add(new Header("User-Agent", "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.102 Safari/537.36"));
		headerList.add(new Header("Content-Type", "application/x-www-form-urlencoded"));
	}

	
	public static String doPost(String url,Map<String,String> map, String cookie){  
...
//					}
	 ...
	 * @param httpPost
	 */
	private static void setOtherHeader(HttpPost httpPost) {
	 ...
	 * @return
	 */
	public static String doAjaxPost(String url,Map<String,String> map, String cookie){  
        HttpClient httpClient = null;  
        HttpPost httpPost = null;  
        String result = null;  
        try{  
...
//    		httpClient.getParams().setParameter(ConnRouteParams.DEFAULT_PROXY, proxy);
	 ...
	 * @param httpPost
	 */
	private static void setAjaxHeader(HttpPost httpPost, String cookie) {
	 ...
	 * @param httpPost
	 */
	private static void setOtherGetHeader(HttpGet httpPost) {
		httpPost.addHeader("Accept", "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8");
		httpPost.addHeader("Accept-Encoding", "gzip, deflate");
		httpPost.addHeader("Accept-Language", "zh-CN,zh;q=0.8");
		httpPost.addHeader("Cache-Control", "max-age=0");
	...
	/**
	 * 判断登录是否成功，yes return true else return false
	 * @param url
	 * @param map
	 * @param cookie
	 * @return
	...
	public static String downloadImage(String url,Map<String,String> map, String cookie, String picPath){  
        HttpClient httpClient = null;  
        HttpPost httpPost = null;  
        String result = null;  
        try{  
            ...
            if(response != null){  
                ...
                File imageFile = new File(picPath + "/img/test_picture.png");  
                //创建输出流  
...
//                }  
	...
	public static String downloadImage_3(String url,Map<String,String> map, String cookie){  
        HttpClient httpClient = null;  
        HttpPost httpPost = null;  
        String result = null;  
        try{  
