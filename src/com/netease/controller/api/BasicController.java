...
public class BasicController extends BaseController {
	...
	final static Logger logger = LoggerFactory.getLogger(BasicController.class);
	...
	public String addBasic(@RequestParam(value = "report_number") String report_number, Model m) {
...
//			logger.info(user.toString());
	...
	public String testLoginDo(@RequestParam(value = "username") String username,
	...
	public String testSignDo(@RequestParam(value = "name") String name,
			@RequestParam(value = "credential_number") String credential_number,
			@RequestParam(value = "login_name") String login_name, @RequestParam(value = "password") String password,
			@RequestParam(value = "mobile_number") String mobile_number, Model m) {
		// 验证信息是否完整
		try {
			if ("".equals(name) || "".equals(credential_number) || "".equals(login_name) || "".equals(password)
	...
	public String testMobileAuth(@RequestParam(value = "mobile_number") String mobile_number, Model m) {
		// 验证手机号
		if (!ValidateUtil.validateMobile(mobile_number)) {
	...
	public String testMobileLoginDo(@RequestParam(value = "mobile_number") String mobile_number,
			@RequestParam(value = "auth_code") String authCode, Model m) {
