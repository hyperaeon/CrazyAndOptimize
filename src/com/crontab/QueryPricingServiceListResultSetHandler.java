...
public class QueryPricingServiceListResultSetHandler implements
ResultSetHandler<List<JsonPricingService>> {

	@Override
	public List<JsonPricingService> handle(ResultSet rs) throws SQLException {
