...
public class QueryPricingServiceResultSetHandler  implements
ResultSetHandler<List<PricingService>> {

	@Override
	public List<PricingService> handle(ResultSet rs) throws SQLException {
