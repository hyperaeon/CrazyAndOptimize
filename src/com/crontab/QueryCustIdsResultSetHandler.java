...
public class QueryCustIdsResultSetHandler implements
		ResultSetHandler<List<JsonImFund>> {

	private static final Logger LOGGER = Logger
			.getLogger(QueryCustIdsResultSetHandler.class);

	@Override
	public List<JsonImFund> handle(ResultSet rs) throws SQLException {
