...
public class QueryOrderNormalSizeResultSetHandler implements
		ResultSetHandler<List<JsonOrderNormalSize>> {

	private static final Logger LOGGER = Logger
		    .getLogger(QueryOrderNormalSizeResultSetHandler.class);
	...
	private void setNormalSize(String ccy1, String ccy2,
			String currency, BigDecimal normalSize,
			JsonOrderNormalSize jsonOrderNormalSize) {
