...
public class JsonOrderNormalSize extends AbstractJson implements Comparable<JsonOrderNormalSize> {
	private String im;
	private String fund;
	...
	public String toString() {
		return "JsonOrderNormalSize [currencyPairGroup=" + currencyPairGroup
				+ ", im=" + im + ", fund=" + fund + ", custId=" + custId
				+ ", ccy1NormalSize=" + ccy1NormalSize + ", ccy2NormalSize="
				+ ccy2NormalSize + ", lastUpdatedById=" + lastUpdatedById
				+ ", lastUpdatedDttm=" + lastUpdatedDttm + ", custIdArr="
				+ Arrays.toString(custIdArr) + "]";
	}
			...
			int flag = this.getIm().compareTo(o.getIm());
				if (flag == 0 && this.getFund() != null && o.getFund() != null) {
					...
					if (flag == 0 && this.getCustId() != null && o.getCustId() != null) {
							...
							if (flag == 0 && this.getCurrencyPairGroup().getPricingServiceId() != null 
									&& o.getCurrencyPairGroup().getPricingServiceId() != null) {
									flag = this.getCurrencyPairGroup().getPricingServiceId().compareTo(o.getCurrencyPairGroup().getPricingServiceId());
									if (flag == 0 && this.getCurrencyPairGroup().getCcy1() != null 
											&& o.getCurrencyPairGroup().getCcy1() != null) {
											flag = this.getCurrencyPairGroup().getCcy1().compareTo(o.getCurrencyPairGroup().getCcy1());
											if (flag == 0 && this.getCurrencyPairGroup().getCcy2() != null 
													&& o.getCurrencyPairGroup().getCcy2() != null) {
