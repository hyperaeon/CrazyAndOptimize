...
public class QueryLegacyFxOrderResultSetHandler implements
		ResultSetHandler<List<LegacyFxOrder>> {

	@Override
	public List<LegacyFxOrder> handle(ResultSet rs) throws SQLException {
