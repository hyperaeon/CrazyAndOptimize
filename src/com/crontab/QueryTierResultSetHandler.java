...
public class QueryTierResultSetHandler implements ResultSetHandler<List<JsonOrderSizeTier>>{
	...
	private static final Logger LOGGER = Logger
		    .getLogger(QueryTierResultSetHandler.class);
	
	@Override
	public List<JsonOrderSizeTier> handle(final ResultSet rs)
			throws SQLException {
	...
	/**
	 * if Ccy1MinimalSize or Ccy2MinimalSize of jsonOrderSizeTier doesn't exist, then set it.
	 * @param currency
	 * @param ccy1
	 * @param ccy2
	 ...
	 * @param minimalSize
	 */
	private void handleMinimalSize(String currency, String ccy1,
			String ccy2, JsonOrderSizeTier jsonOrderSizeTier,
			BigDecimal minimalSize) {
		if (ccy1 != null && ccy1.trim().equalsIgnoreCase(currency.trim()) 
